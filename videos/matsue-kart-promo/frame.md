...
colors:
  ink-black: "#0B1A2A"
  ink-black-alt: "#12263D"
  fire-orange: "#FFD83D"
  cream: "#FFFFFF"
  cream-muted: "rgba(255,255,255,0.72)"
  cream-hint: "rgba(255,255,255,0.45)"
...
**Hand-corrected for MATSUE KART (Japanese, footage-led):** the automatic remix inverted the
registers (white ground). Corrected to the site's own look: **dark register = navy #0B1A2A ground,
white text, brand yellow #FFD83D accent**; the "orange" register is brand yellow with navy ink.
Display type is **Noto Sans JP 900** (Japanese has no case, so the lowercase rule does not apply;
Latin words such as "MATSUE KART" are uppercase italic, as on the game's start banner). Game footage
is the ground on most frames; type sits over it with a navy scrim or a yellow slab.
